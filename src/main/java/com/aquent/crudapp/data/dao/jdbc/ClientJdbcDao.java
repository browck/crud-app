...
public class ClientJdbcDao implements ClientDao {
    ...
    private static final String SQL_CREATE_CLIENT = "INSERT INTO client (company_name, website, phone_number, street_address, city, state, zip_code)"
                                                  + " VALUES (:companyName, :website, :phoneNumber, :streetAddress, :city, :state, :zipCode)";
